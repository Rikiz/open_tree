...
export function BookmarkWindow({ bookmarks, onOpenRepo, onAddRepo, onRemoveRepo }: Props) {
  ...
  return (
    <div className="h-screen flex flex-col bg-background">
      <header className={'h-12 border-b flex items-center justify-between pr-4 shrink-0' + (/Mac/i.test(navigator.platform) ? ' pl-[76px]' : ' pl-4')} style={{ WebkitAppRegion: 'drag' } as React.CSSProperties}>
